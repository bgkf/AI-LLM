...
INSTALL_DIR="/Users/$LOGGED_IN_USER/Library/Application Support/OktaDashboard"
...
runAsUser "$INSTALL_DIR/venv/bin/pip" install -r "$INSTALL_DIR/requirements.txt" --quiet >> "$LOG" 2>&1
